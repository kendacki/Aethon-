...
export default function AgentDetailPage() {
  ...
  return (
    <PageWrap>
      <Section>
        <Link to="/agents" style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "rgba(255,255,255,0.6)", fontSize: "0.875rem", marginBottom: "2rem" }}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={spring}>
          ...
          <Grid cols={3} style={{ marginTop: "2rem" }}>
            <Card glow>
              ...
              <div style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.875rem", marginTop: 8 }}>Reputation Score</div>
            </Card>
            <Card>
              <StatValue style={{ fontSize: "1.75rem" }}>{formatEth(agent.stake)}</StatValue>
              <div style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.875rem", marginTop: 8 }}>Staked</div>
            </Card>
            <Card>
              <div style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.5)" }}>Last Heartbeat</div>
            ...
            <Card style={{ marginTop: "2rem" }}>
              ...
              {rep.history.map((h, i) => (
                ...
                >
                  ...
                  <span style={{ color: "rgba(255,255,255,0.4)" }}>{new Date(h.createdAt).toLocaleDateString()}</span>
                </motion.div>
              ))}
            </Card>
          )}
